...
int EMD_wrap(int supply_count,int demand_count, double *supply_weights, double *demand_weights,double *distance_matrix, double *flow_matrix, double* alpha, double* beta, double *cost, uint64_t maxIter);
